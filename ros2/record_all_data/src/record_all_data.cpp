...
public:
        ...
        : Node("record_all_data")
    {
        ...
        lidar_subscription_ = create_subscription<std_msgs::msg::String>(
            lidar_topic_name, 10, std::bind(&BagRecorder::lidar_topic_callback, this, _1));

        image_subscription_ = create_subscription<std_msgs::msg::String>(
            image_topic_name, 10, std::bind(&BagRecorder::image_topic_callback, this, _1));

        imu_subscription_ = create_subscription<std_msgs::msg::String>(
